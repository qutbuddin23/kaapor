...
$(document).ready(function () {
    ...
    if ($('#instaFeed-style1').length != 0) {
        ...
        var token = 'IGQVJXaGRsQnJCdUJmekpsWUVXVDBvWS00ckt5OWpPckdQeFlWRnltSUMtMjhtVTNtQmRpcUhpQ19XSjNsbWhzVmMxMXJpdzhhc2tZAanlKZAmFZAaklPcEd5TU9Ga2FIWVpYYXVEOXZANMzhfZAlFpU1R6MgZDZD';
    ...
    if ($('#instaFeed-aside').length != 0) {
        ...
        var token = 'IGQVJXaGRsQnJCdUJmekpsWUVXVDBvWS00ckt5OWpPckdQeFlWRnltSUMtMjhtVTNtQmRpcUhpQ19XSjNsbWhzVmMxMXJpdzhhc2tZAanlKZAmFZAaklPcEd5TU9Ga2FIWVpYYXVEOXZANMzhfZAlFpU1R6MgZDZD'; // learn how to obtain it below
